...
### Verification rules
- **Every milestone's "Verify" step is executed in two real browser windows**, not reasoned about. Record it as one line in the commit body ("verified: two tabs, card move propagates < 1s").
